...
- Fully redesigned the website UI with a modern industrial aesthetic, significantly improving visual quality and consistency.
- Unified the visual style across all pages — homepage, client page, and changelog now share a cohesive design language.
- Overhauled the navbar with a sticky layout and frosted glass background effect.
- Redesigned the homepage hero section, replacing third-party background images with a custom brand-color grid pattern.
- Redesigned the how-to-use section with a timeline-style layout for clearer visual hierarchy.
- Converted the FAQ section to a smooth accordion with animated expand/collapse.
- Removed the novel hot list feature.
- Unified Markdown typography styles on the changelog page to match the overall design system.
